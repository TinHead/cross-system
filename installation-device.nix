...

{
  imports =
    [ # Enable devices which are usually scanned, because we don't know the
      # target system.
      (nixpkgsPath + "/nixos/modules/installer/scan/detected.nix")
      (nixpkgsPath + "/nixos/modules/installer/scan/not-detected.nix")

      # Allow "nixos-rebuild" to work properly by providing
      # /etc/nixos/configuration.nix.
      (nixpkgsPath + "/nixos/modules/profiles/clone-config.nix")
